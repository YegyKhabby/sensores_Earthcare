# -*- coding: utf-8 -*-
"""
compare_ze_fwd_cloudnet_masked_shift45.py
==================================
Same as compare_ze_fwd_cloudnet_masked.py but with one extra timing option:

  Cloudnet time shift
    • Cloudnet timestamps are shifted by +45 s before matching.
      This compares Parsivel at time t to Cloudnet around t-45 s in physical time.
...
Usage
-----
  python3 compare_ze_fwd_cloudnet_masked_shift45.py          # runs TEST_DATES
  python3 compare_ze_fwd_cloudnet_masked_shift45.py 20250607 # single date

Outputs per date (in output/comparison/cloudnet_vs_fwd_masked_shift45/<date>/):
...
OUT_BASE       = Path('/work/yegy_project/Feb2026_new/output/comparison/cloudnet_vs_fwd_masked_shift45')
...
CN_TIME_SHIFT_S = 35.0  # seconds, applied to Cloudnet timestamps before matching
